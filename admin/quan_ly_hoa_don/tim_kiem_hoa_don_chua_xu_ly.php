...
khach_hang.dia_chi
from hoa_don
join khach_hang on hoa_don.ma_khach_hang = khach_hang.ma where tinh_trang = '1' and thoi_gian_mua >= '$ngay_bat_dau 00:00:00' and thoi_gian_mua <= '$ngay_ket_thuc 23:59:59' and sdt like '%$tim_kiem%' order by ma asc";
...
<h1>
	Số hóa đơn chưa xử lý: <?php echo $tong_so_hoa_don ?>
</h1>
<p>
	Trang: <?php for($i = 1; $i<=$tong_so_trang; $i++){ ?>
		<a href="?trang=<?php echo $i ?>&ngay_bat_dau=<?php echo $ngay_bat_dau ?>&ngay_ket_thuc=<?php echo $ngay_ket_thuc ?>&tim_kiem=<?php echo $tim_kiem ?>">
			<?php echo $i ?>
		</a>
	<?php } ?>
</p>

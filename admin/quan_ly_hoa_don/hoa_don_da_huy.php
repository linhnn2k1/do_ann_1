...
khach_hang.dia_chi
from hoa_don
join khach_hang on hoa_don.ma_khach_hang = khach_hang.ma where tinh_trang = '3' order by ma asc";
...
?>
<h1>
	Số hóa đơn đã hủy: <?php echo $tong_so_hoa_don ?>
</h1>
<p>
...
<form action="tim_kiem_hoa_don_da_huy.php" method="get">
				...
				<?php } else { ?>
					<span class="mau_do in_dam">
						<?php	
							...
							echo "Lý do: ";
						?>
						<textarea readonly style="width: 100%; height: 70px; font-size: 16px">

...
khach_hang.dia_chi
from hoa_don
join khach_hang on hoa_don.ma_khach_hang = khach_hang.ma where thoi_gian_mua >= '$ngay_bat_dau 00:00:00' and thoi_gian_mua <= '$ngay_ket_thuc 23:59:59' and sdt like '%$tim_kiem%' order by ma asc";
...
<h1>
	Số hóa đơn: <?php echo $tong_so_hoa_don ?>
</h1>
<p>
